...
package com.example.textrecognition.java.textdetector;
...
import com.example.textrecognition.GraphicOverlay.Graphic;
...
public class TextGraphic extends Graphic {
  ...
  public void draw(Canvas canvas) {
    ...
    ChooserActivity.formattedText.setLength(0);
    ChooserActivity.formattedText.append(text.getText());
    for (TextBlock textBlock : text.getTextBlocks()) {
      // Renders the text at the bottom of the box.
      ChooserActivity.allTextExtracted.add(textBlock.getText());
