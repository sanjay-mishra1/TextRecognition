...
import com.example.textrecognition.BitmapUtils;
import com.example.textrecognition.GraphicOverlay;
import com.example.textrecognition.R;
import com.example.textrecognition.VisionImageProcessor;
import com.example.textrecognition.app.AllTextViewerActivity;
import com.example.textrecognition.java.textdetector.TextRecognitionProcessor;
...
public final class StillImageActivity extends AppCompatActivity {
  ...
  private static final String KEY_IMAGE_URI = "com.example.textrecognition.KEY_IMAGE_URI";
  private static final String KEY_SELECTED_SIZE = "com.example.textrecognition.KEY_SELECTED_SIZE";
  ...
  private String selectedMode = TEXT_RECOGNITION;
  ...
  protected void onCreate(Bundle savedInstanceState) {
   ...
   findViewById(R.id.settings_button).setVisibility(View.INVISIBLE);
    findViewById(R.id.viewText_button).setOnClickListener(v -> {
      Intent intent = new Intent(getApplicationContext(), AllTextViewerActivity.class);
  ...
  private void tryReloadAndDetectInImage() {
    ...
    try {
      ...
      ChooserActivity.allTextExtracted.clear();
  ...
  private void createImageProcessor() {
    try { imageProcessor = new TextRecognitionProcessor(this);
    } catch (Exception e) {
